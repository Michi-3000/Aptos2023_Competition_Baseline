...
def show(img,w=6,nc=4,title=None,save=None,cols=['impath']):
...
def splitdf(df,by='eid',test_size=.1):
...
# import csv
# with open("csvs/extractmp.csv", 'a', newline='') as csvfile:
#     fieldnames = atts+['Modality','imshape','eid','jpg']
