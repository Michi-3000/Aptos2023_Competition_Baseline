...
def vqa_collate_fn(batch):
    image_list, question_list, answer_list, weight_list, n, path_list= [], [], [], [], [], []
    for image, question, answer, weights, path in batch:
    ...
    return torch.stack(image_list,dim=0), question_list, answer_list, torch.Tensor(weight_list), path_list, n        
